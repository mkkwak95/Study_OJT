          ...
          <form className="Leave_form">
            ...
            <div className="Leave_input">
              ...
              <label htmlFor="pwd" className="floating_label">
                비밀번호&nbsp;<span className="Leave_span">(필수)</span>
              </label>
            </div>
            <button type="submit" className="Leave_submit">
              회원 탈퇴
            </button>
            <button type="cancel" className="Leave_cancel">
              돌아가기
            </button>
          </form>
        </div>
